    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <section className="flex items-start justify-between">
        <div>
          ...
          <p className="font-mono text-sm text-slate-500 mt-1">{today}</p>
        </div>
      ...
      {/* Section 4: Quick Plan CTA + Recent Trips */}
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col">
          <div className="flex items-center justify-between mb-4">
            ...
            {trips.length > 0 && (
              <Link
                to="/trips"
                className="text-accent hover:text-teal-600 text-sm font-sans transition-colors"
              >
                View all →
              </Link>
            )}
          ...
          {recentTrips.length === 0 ? (
            <div className="flex flex-col items-center justify-center gap-4 bg-white border border-slate-200 border-dashed rounded-2xl p-10 min-h-[200px] flex-1">
              ...
              <div className="text-center max-w-xs">
                <h3 className="font-display text-xl text-slate-700 mb-1">
                  No trips yet
                </h3>
                <p className="font-sans text-sm text-slate-400">
                  Your planned adventures will appear here. Start by planning
                  your first trip!
                </p>
              </div>
              <button
